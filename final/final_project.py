...
#   Features:
#    Presentation of assets, passives, and capital(elements of a general balance) and information of a sales statement.
#    This information will be easily watchable in an excel file.
#    What new skills will you need to acquire? What topics will you need to research?
#    Knowledge of all the information under a basic balance sheet and a sales statement. 
